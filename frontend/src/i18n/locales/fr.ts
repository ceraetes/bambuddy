export default {
  ...
  slice: {
    ...
    projectOverrides: {
      label: 'Utiliser les dérogations de processus 3MF',
      description:
        'Appliquer les supports et autres réglages de processus enregistrés dans le fichier projet au profil de processus sélectionné (p. ex. après changement d’imprimante).',
      mappedProcessHint: 'Processus : {{from}} → {{to}}',
      embeddedProcessLabel: 'Processus 3MF : {{name}}',
      suggestedProcessMatch: 'Correspondance suggérée sur cette imprimante : {{name}}',
      listSummary: '{{enabled}} sur {{total}} dérogations',
    },
  },
